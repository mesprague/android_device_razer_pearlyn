...
BOARD_KERNEL_CMDLINE := console=null androidboot.hardware=qcom androidboot.selinux=permissive user_debug=31 androidboot.veritymode=enforcing vmalloc=400MB
...
# Recovery
TARGET_RECOVERY_FSTAB := $(PEARLYN_PATH)/recovery.fstab
